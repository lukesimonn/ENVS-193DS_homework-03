...
This is piece is a network display of my daily walk time to my 8 am class, heavily influenced by the creation of real network maps I have made for my job and shape and color work of Posavec and Lupi. This was created on the free and open source network mapping platform draw.io. Paths are created to represent which of the two buildings I was going to (in chronological order), colors follow rainbow order (red-purple) for walk time (red = 12, purple = 21) and the number of sides of each shape represents how many minutes after 7:50 I arrived, horizontal location is by daily temperature, while vertical is by wake-up time.
